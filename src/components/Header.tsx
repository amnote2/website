...
export default function Header({ onToggleSidebar, onLogout, onMenuSelect, currentMenuTitle }: HeaderProps) {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden sm:block">
            ...
            <h2 className="text-lg font-bold text-gray-900">
              {currentMenuTitle || 'Dashboard Tổng Quan'}
            </h2>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            {isNotificationDropdownOpen && (
              <>
                ...
                {/* Dropdown Content */}
                <div
                  className="absolute right-0 mt-2 w-full max-w-[95vw] sm:w-80 sm:max-w-none bg-white rounded-2xl sm:rounded-lg shadow-lg border border-gray-200 z-20"
